...
{
    internal class PushBackgroundTaskNotificationServiceDecorator : INotificationsService
    {
        public const string BackgroundTaskName = "InsaneNotifications.UWP.BackgroundPushHandler";

        private readonly INotificationsService _decoratedNotificationsService;

        public PushBackgroundTaskNotificationServiceDecorator(INotificationsService decoratedNotificationsService)
        {
